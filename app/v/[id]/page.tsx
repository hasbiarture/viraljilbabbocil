...
export default async function Video({ params }: PageProps) {
    ...
    const file = data.result[0];
        ...
        url: `https://viraljilbabbocil.pages.dev/v/${file.filecode}`,
        ...
        publisher: {
            '@type': 'Organization',
            name: `${SITENAME}`,
            logo: 'https://viraljilbabbocil.pages.dev/favicon.ico'},
            author: {
                '@type': 'Person',
                name: 'admin',
                url: 'https://viraljilbabbocil.pages.dev'
              }
        }
        const jsonLd2 = {
        '@context': 'https://schema.org',
